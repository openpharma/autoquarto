...
`autoquarto` includes an app that allows users to provide definitions for parameters in the YAML header of a Quarto document (or in the headers of indvidiual chapters of a Quarto book or website).  The easiest way to access the website is by calling the `askForparams` function:
